...
Ext.onReady(function() {
    ...
    var grid = new xg.GridPanel({
        ...
        width    : 700,
        height   : 450,
        title    : 'Checkbox Grouping Example',
        store    : store,
        selModel : selModel,
        columns  : [
            selModel,
        ...
        view    : new Ext.ux.grid.CheckboxGroupingView({
            forceFit     : true,
            groupTextTpl : '<div class="x-grid3-group-check">&nbsp;</div>{text} ({[values.rs.length]} {[values.rs.length > 1 ? "Items" : "Item"]})'
        })
    });
});
